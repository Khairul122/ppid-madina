            ...
            <div class="col-sm-12">
              ...
              <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="d-flex align-items-center">
                  ...
                  <span style="font-size: 18px; font-weight: 500;">Draft / Kategori Berkala</span>
                </div>
                ...
                <div class="d-flex gap-2">
                  ...
                  <button class="btn btn-secondary" onclick="window.location.href='index.php?controller=kategoriberkala&action=index'">
                ...
                <nav aria-label="Page navigation" class="mt-3">
                  <ul class="pagination justify-content-center">
                    ...
                    <?php if ($pagination['current_page'] > 1): ?>
                      <li class="page-item">
                        <a class="page-link" href="?controller=kategoriberkala&action=draft&page=<?php echo $pagination['current_page'] - 1; ?>&limit=<?php echo $pagination['limit']; ?><?php echo !empty($search) ? '&search=' . urlencode($search) : ''; ?>">
                          Previous
                        </a>
                      </li>
                    <?php else: ?>
                    ...
                    ?>
                      <li class="page-item">
                        <a class="page-link" href="?controller=kategoriberkala&action=draft&page=1&limit=<?php echo $pagination['limit']; ?><?php echo !empty($search) ? '&search=' . urlencode($search) : ''; ?>">1</a>
                      </li>
                      <?php if ($start_page > 2): ?>
                    ...
                    <?php for ($i = $start_page; $i <= $end_page; $i++): ?>
                      <li class="page-item <?php echo $i == $pagination['current_page'] ? 'active' : ''; ?>">
                        <a class="page-link" href="?controller=kategoriberkala&action=draft&page=<?php echo $i; ?>&limit=<?php echo $pagination['limit']; ?><?php echo !empty($search) ? '&search=' . urlencode($search) : ''; ?>">
                          <?php echo $i; ?>
                        </a>
                      </li>
                    <?php endfor; ?>
                    ...
                    <?php if ($end_page < $pagination['total_pages']): ?>
                      ...
                      <?php endif; ?>
                      <li class="page-item">
                        <a class="page-link" href="?controller=kategoriberkala&action=draft&page=<?php echo $pagination['total_pages']; ?>&limit=<?php echo $pagination['limit']; ?><?php echo !empty($search) ? '&search=' . urlencode($search) : ''; ?>">
              ...
              <?php else: ?>
                <div class="text-center py-5">
                  ...
                  <h5 class="text-muted mt-3">
                    ...
                    <?php else: ?>
                      Belum ada draft dokumen berkala
                    <?php endif; ?>
                  </h5>
  ...
  <script>
    ...
    document.getElementById('confirmPublikasiBtn').addEventListener('click', function() {
      if (currentDokumenId) {
        ...
        fetch('index.php?controller=kategoriberkala&action=updateToPublikasi', {
          method: 'POST',
          body: formData
        })
