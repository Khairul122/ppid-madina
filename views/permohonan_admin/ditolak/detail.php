              ...
              <div class="page-header mb-4">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                  <div class="mb-2 mb-md-0">
                    <h4 class="page-title mb-1 text-dark">Detail Permohonan Ditolak</h4>
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb mb-0 fs-6">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?controller=permohonanadmin&action=ditolakIndex" class="text-decoration-none">Ditolak</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Detail</li>
                      </ol>
                    </nav>
                  </div>
                  <div class="d-flex flex-column flex-sm-row gap-2">
                    <a href="index.php?controller=permohonanadmin&action=ditolakIndex" class="btn btn-outline-secondary btn-sm">
                      ...
                      <div class="row g-3">
                        ...
                        <div class="col-md-6">
                          <div class="info-item">
                            ...
                            <div class="info-value">
                              <span class="badge bg-warning text-dark fs-6 px-3 py-2"><?php echo htmlspecialchars($permohonan['alasan_penolakan'] ?? '-'); ?></span>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body p-4">
                      <div class="d-grid gap-3">
                        ...
                        <!-- Preview Bukti Ditolak -->
                        <a href="index.php?controller=permohonanadmin&action=generateBuktiDitolakPDF&id=<?php echo $permohonan['id_permohonan']; ?>"
                           class="btn btn-danger btn-lg" target="_blank">
                          <i class="fas fa-file-times me-2"></i>Bukti Ditolak
                        </a>
                      </div>

                      <div class="alert alert-danger mt-3 mb-0" role="alert">
                        <i class="fas fa-times-circle me-2"></i>
                        <small><strong>Catatan:</strong> Permohonan ini ditolak. Dokumen bukti penolakan siap untuk dicetak dan diberikan kepada pemohon.</small>
                      </div>
                    </div>
                  </div>
