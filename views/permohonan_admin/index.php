                  ...
                  <div class="card stats-card border-0 shadow-sm">
                    <div class="card-body p-4">
                      <div class="d-flex align-items-center">
                        ...
                        <div>
                          <div class="stats-number"><?php echo $stats['diproses'] ?? 0; ?></div>
              ...
              <div class="page-header mb-4">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                  ...
                  <div class="d-flex gap-2">
                    <a href="index.php?controller=permohonanadmin&action=create" class="btn btn-primary">
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="btn-group" role="group">
                                  <a href="index.php?controller=permohonanadmin&action=view&id=<?php echo $permohonan['id_permohonan']; ?>"
                                     class="btn btn-sm btn-info" title="Lihat Detail">
                                    <i class="mdi mdi-eye"></i>
                                  </a>
                                  <a href="index.php?controller=permohonanadmin&action=edit&id=<?php echo $permohonan['id_permohonan']; ?>"
