                  ...
                  <div class="mb-2 mb-md-0">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb mb-0 fs-6">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?controller=permohonanadmin&action=keberatanIndex" class="text-decoration-none">Keberatan</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Detail</li>
                      </ol>
                    </nav>
                  </div>
                  <div class="d-flex gap-2">
                    <a href="index.php?controller=permohonanadmin&action=keberatanIndex" class="btn btn-outline-secondary btn-sm">
