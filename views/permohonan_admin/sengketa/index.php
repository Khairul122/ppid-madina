              ...
              <div class="page-header mb-4">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                  <div class="mb-2 mb-md-0">
                    <h4 class="page-title mb-1 text-dark">Permohonan Sengketa</h4>
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb mb-0 fs-6">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Sengketa</li>
                      </ol>
                    </nav>
                  </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-center">
                        <div>
                          <h6 class="text-muted mb-1">Total Permohonan Sengketa</h6>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <form method="GET" action="index.php" class="row g-3">
                    ...
                    <input type="hidden" name="action" value="sengketaIndex">

                    <div class="col-md-8">
                      <label class="form-label">Pencarian</label>
                      <input type="text" name="search" class="form-control" placeholder="Cari berdasarkan nomor, judul, nama pemohon, atau NIK..." value="<?php echo htmlspecialchars($search ?? ''); ?>">
                    </div>
                    ...
                    <div class="col-md-2">
                      <label class="form-label">&nbsp;</label>
                      <a href="index.php?controller=permohonanadmin&action=sengketaIndex" class="btn btn-outline-secondary d-block w-100">
                ...
                <div class="card-body">
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                <span class="badge bg-info"><?php echo htmlspecialchars($p['tujuan_permohonan'] ?? ''); ?></span>
                              </td>
                              <td>
                              ...
                              <td>
                                <span class="badge bg-danger">Sengketa</span>
                              </td>
                              <td>
                                <div class="btn-group" role="group">
                                  <a href="index.php?controller=permohonanadmin&action=sengketaView&id=<?php echo $p['id_permohonan']; ?>"
                    ...
                    <?php if ($total_pages > 1): ?>
                      <nav aria-label="Page navigation" class="mt-4">
                        <ul class="pagination justify-content-center">
                          <?php if ($page > 1): ?>
                            <li class="page-item">
                              <a class="page-link" href="?controller=permohonanadmin&action=sengketaIndex&page=<?php echo ($page - 1); ?>&search=<?php echo urlencode($search ?? ''); ?>">
                          ...
                          <?php for ($i = max(1, $page - 2); $i <= min($total_pages, $page + 2); $i++): ?>
                            <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                              <a class="page-link" href="?controller=permohonanadmin&action=sengketaIndex&page=<?php echo $i; ?>&search=<?php echo urlencode($search ?? ''); ?>">
                                <?php echo $i; ?>
                              </a>
                            </li>
                          <?php endfor; ?>
                  ...
                  <?php else: ?>
                    <div class="text-center py-5">
                      ...
                      <h5 class="text-muted mt-3">Tidak ada data permohonan sengketa</h5>
                      <p class="text-muted">Belum ada permohonan dengan status sengketa.</p>
                    </div>
                  <?php endif; ?>
                </div>
              </div>
