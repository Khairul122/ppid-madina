              ...
              <div class="page-header mb-4">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                  <div class="mb-2 mb-md-0">
                    <h4 class="page-title mb-1 text-dark">Detail Permohonan Sengketa</h4>
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb mb-0 fs-6">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?controller=permohonanadmin&action=sengketaIndex" class="text-decoration-none">Sengketa</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Detail</li>
                      </ol>
                    </nav>
                  </div>
                  <div class="d-flex gap-2">
                    <a href="index.php?controller=permohonanadmin&action=sengketaIndex" class="btn btn-outline-secondary btn-sm">
                      ...
                      <div class="row g-3">
                        ...
                        <div class="col-md-6">
                          <div class="info-item">
                            ...
                            <div class="info-value">
                              <span class="badge bg-danger fs-6 px-3 py-2">Sengketa</span>
                            </div>
                          </div>
                        </div>
