                  ...
                  <div class="mb-2 mb-md-0">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb mb-0 fs-6">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?controller=permohonanpetugas&action=layananKepuasanIndex" class="text-decoration-none">Layanan Kepuasan</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Detail</li>
                      </ol>
                    </nav>
                    <div class="mt-2">
                      <span class="badge bg-info fs-6 px-3 py-2">
                        <i class="fas fa-building me-1"></i><?php echo htmlspecialchars($layanan_kepuasan['komponen_tujuan'] ?? 'SKPD'); ?>
                      </span>
                    </div>
                  </div>
                  <div class="d-flex flex-column flex-sm-row gap-2">
                    <a href="index.php?controller=permohonanpetugas&action=layananKepuasanIndex" class="btn btn-outline-secondary btn-sm">
