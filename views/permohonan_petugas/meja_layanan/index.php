              ...
              <div class="page-header mb-4">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                  <div class="mb-2 mb-md-0">
                    <h4 class="page-title mb-1 text-dark">Meja Layanan Petugas</h4>
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb mb-0 fs-6">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Meja Layanan</li>
                      </ol>
                    </nav>
                  </div>
                </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <form method="GET" action="index.php" class="row g-3">
                    ...
                    <input type="hidden" name="action" value="mejaLayanan">
                    ...
                    <div class="col-md-2">
                      <label class="form-label">&nbsp;</label>
                      <a href="index.php?controller=permohonanpetugas&action=mejaLayanan" class="btn btn-outline-secondary d-block w-100">
                  ...
                  <?php if ($total_pages > 1): ?>
                    <nav aria-label="Page navigation" class="mt-4">
                      <ul class="pagination justify-content-center">
                        <?php if ($page > 1): ?>
                          <li class="page-item">
                            <a class="page-link" href="index.php?controller=permohonanpetugas&action=mejaLayanan&page=<?php echo $page - 1; ?>&status=<?php echo urlencode($status ?? 'all'); ?>&search=<?php echo urlencode($search ?? ''); ?>">
                        ...
                        <?php for ($i = max(1, $page - 2); $i <= min($total_pages, $page + 2); $i++): ?>
                          <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                            <a class="page-link" href="index.php?controller=permohonanpetugas&action=mejaLayanan&page=<?php echo $i; ?>&status=<?php echo urlencode($status ?? 'all'); ?>&search=<?php echo urlencode($search ?? ''); ?>">
                              <?php echo $i; ?>
                            </a>
                          </li>
                        <?php endfor; ?>
