                  ...
                  <div class="mb-2 mb-md-0">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb mb-0 fs-6">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?controller=permohonanpetugas&action=permohonanDitolak" class="text-decoration-none">Permohonan Ditolak</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Detail</li>
                      </ol>
                    </nav>
                  </div>
                  <div class="d-flex flex-column flex-sm-row gap-2">
                    <a href="index.php?controller=permohonanpetugas&action=generateBuktiDitolakPDF&id=<?php echo $permohonan['id_permohonan']; ?>" 
                       class="btn btn-danger btn-sm" target="_blank">
                      <i class="fas fa-file-pdf me-1"></i>Bukti Ditolak (PDF)
                    </a>
