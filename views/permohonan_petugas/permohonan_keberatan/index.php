              ...
              <div class="page-header mb-4">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                  <div class="mb-2 mb-md-0">
                    <h4 class="page-title mb-1 text-dark">Permohonan Keberatan</h4>
                  ...
                  <div class="d-flex gap-2">
                    <a href="index.php?controller=permohonanpetugas&action=index" class="btn btn-outline-secondary btn-sm">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-center">
                        <div>
                          <h6 class="text-muted mb-1">Total Permohonan Keberatan</h6>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <form method="GET" action="index.php" class="row g-3">
                    ...
                    <input type="hidden" name="action" value="keberatanIndex">
                    ...
                    <div class="col-md-2">
                      <label class="form-label">&nbsp;</label>
                      <a href="index.php?controller=permohonanpetugas&action=keberatanIndex" class="btn btn-outline-secondary d-block w-100">
                ...
                <div class="card-body">
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                <span class="badge bg-warning">Keberatan</span>
                              </td>
                              <td>
                    ...
                    <?php if ($total_pages > 1): ?>
                      <nav aria-label="Page navigation" class="mt-4">
                        <ul class="pagination justify-content-center">
                          <?php if ($page > 1): ?>
                            <li class="page-item">
                              <a class="page-link" href="?controller=permohonanpetugas&action=keberatanIndex&page=<?php echo ($page - 1); ?>&search=<?php echo urlencode($search ?? ''); ?>">
                          ...
                          <?php for ($i = max(1, $page - 2); $i <= min($total_pages, $page + 2); $i++): ?>
                            <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                              <a class="page-link" href="?controller=permohonanpetugas&action=keberatanIndex&page=<?php echo $i; ?>&search=<?php echo urlencode($search ?? ''); ?>">
                                <?php echo $i; ?>
                              </a>
                            </li>
                          <?php endfor; ?>
                  ...
                  <?php else: ?>
                    <div class="text-center py-5">
                      ...
                      <h5 class="text-muted mt-3">Tidak ada data permohonan keberatan</h5>
                      <p class="text-muted">Belum ada permohonan dengan status keberatan.</p>
                    </div>
                  <?php endif; ?>
                </div>
              </div>
