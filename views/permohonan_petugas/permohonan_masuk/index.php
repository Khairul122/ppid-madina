            ...
            <div class="col-sm-12">
              ...
              <div class="page-header mb-4">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                  <div class="mb-2 mb-md-0">
                    <h4 class="page-title mb-1 text-dark">Permohonan Masuk - <?php echo htmlspecialchars($petugas_skpd['nama_skpd'] ?? ''); ?></h4>
              ...
              <div class="alert alert-info mb-4" role="alert">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <strong>Informasi:</strong> Halaman ini menampilkan permohonan yang ditujukan ke <strong><?php echo htmlspecialchars($petugas_skpd['nama_skpd'] ?? ''); ?></strong>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <form method="GET" action="index.php" class="row g-3">
                    ...
                    <div class="col-md-2">
                      <label class="form-label">&nbsp;</label>
                      <a href="index.php?controller=permohonanpetugas&action=permohonanMasuk" class="btn btn-outline-secondary d-block w-100">
                ...
                <div class="card-body">
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="btn-group" role="group">
                                  <a href="index.php?controller=permohonanpetugas&action=view&id=<?php echo $permohonan['id_permohonan']; ?>"
                    ...
                    <?php if ($total_pages > 1): ?>
                      <nav aria-label="Page navigation" class="mt-4">
                        <ul class="pagination justify-content-center">
                          <?php if ($page > 1): ?>
                            <li class="page-item">
                              <a class="page-link" href="index.php?controller=permohonanpetugas&action=permohonanMasuk&page=<?php echo $page - 1; ?>&status=<?php echo urlencode($status ?? 'all'); ?>&search=<?php echo urlencode($search ?? ''); ?>">
                          ...
                          <?php for ($i = max(1, $page - 2); $i <= min($total_pages, $page + 2); $i++): ?>
                            <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                              <a class="page-link" href="index.php?controller=permohonanpetugas&action=permohonanMasuk&page=<?php echo $i; ?>&status=<?php echo urlencode($status ?? 'all'); ?>&search=<?php echo urlencode($search ?? ''); ?>">
                                <?php echo $i; ?>
                              </a>
                            </li>
                          <?php endfor; ?>
                  ...
                  <?php else: ?>
                    <div class="text-center py-5">
                      ...
                      <p class="text-muted">Belum ada permohonan yang ditujukan ke SKPD Anda.</p>
                    </div>
                  <?php endif; ?>
                </div>
              </div>
