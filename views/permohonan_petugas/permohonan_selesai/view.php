                  ...
                  <div class="mb-2 mb-md-0">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb mb-0 fs-6">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?controller=permohonanpetugas&action=selesaiIndex" class="text-decoration-none">Selesai</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Detail</li>
                      </ol>
                    </nav>
                  </div>
                  <div class="d-flex flex-column flex-sm-row gap-2">
                    <a href="index.php?controller=permohonanpetugas&action=selesaiIndex" class="btn btn-outline-secondary btn-sm">
                  ...
                  <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body p-4">
                      <div class="d-grid gap-3">
                        ...
                        <a href="index.php?controller=permohonanpetugas&action=generateBuktiSelesaiPDF&id=<?php echo $permohonan['id_permohonan']; ?>"
                           class="btn btn-success btn-lg" target="_blank">
