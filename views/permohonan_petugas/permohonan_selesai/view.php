              ...
              <div class="page-header mb-4">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                  <div class="mb-2 mb-md-0">
                    ...
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb mb-0 fs-6">
                        <li class="breadcrumb-item"><a href="index.php?controller=permohonanpetugas&action=permohonanSelesai" class="text-decoration-none">Permohonan Selesai</a></li>
                  ...
                  <div class="d-flex flex-column flex-sm-row gap-2">
                    ...
                    <a href="index.php?controller=permohonanpetugas&action=permohonanSelesai" class="btn btn-outline-secondary btn-sm">
