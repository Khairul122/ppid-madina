                        ...
                        <div class="profile-card">
                            ...
                            <div class="tab-container">
                                ...
                                <div id="profile" class="tab-content active">
                                    <form method="POST" action="index.php?controller=profilepetugas&action=updateProfile">
                                        <div class="form-row">
                                            <div class="form-col">
                                ...
                                <div id="password" class="tab-content">
                                    <form method="POST" action="index.php?controller=profilepetugas&action=updatePassword">
                                        <div class="form-group">
                                ...
                                <div id="photo" class="tab-content">
                                    <form method="POST" action="index.php?controller=profilepetugas&action=updatePhoto" enctype="multipart/form-data">
                                        <div class="form-group">
